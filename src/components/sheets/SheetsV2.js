...
class SheetsV2 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <table>
        <thead>
          ...
          <th className="SheetsV2NotSortable">Actions</th>
          </tr>
        </thead>
          ...
          {this.state.data.map((row, rowidx) => {
            return (
              <tr key={rowidx}>{
                ...
                <td className="SheetsV2DataCenter">
